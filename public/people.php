...
$wp->appendContent(<<<HTML
    ...
    <main>
        <div class="buttons">
        <a href="menus/updatePeople.php?peopleId={$peopleId}" class="menu_updatePeople_button">
                <svg class="svg-icon" viewBox="0 0 20 20" height="50">
            ...
            <a href="menus/deletePeople.php?peopleId={$peopleId}" class="menu_deletePeople_button">
                <svg class="svg-icon" viewBox="0 0 20 20" height="45">
