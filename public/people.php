...
$wp->appendContent(<<<HTML
    ...
    <main>
        <a href="menus/updatePeople.php?movieId={$peopleId}" class="menu_updatePeople_button">
            ...
            <a href="menus/deletePeople.php?movieId={$peopleId}" class="menu_deletePeople_button">
